...
import { Home, ShoppingCart, Package, History, User, LayoutDashboard, Users, Truck, Bell, FileText, Settings, LogOut, Menu, Store, FolderOpen, Boxes, Target, TrendingUp } from 'lucide-react';
...
const sellerNavItems = [{
  ...
  url: '/vendeur/nouvelle-vente',
  icon: ShoppingCart
}, {
  title: 'Historique Ventes',
  url: '/vendeur/historique-ventes',
  icon: History
}, {
...
const adminNavItems = [{
  ...
  title: 'Fournisseurs',
  url: '/manager/fournisseurs',
  icon: Truck
}, {
  title: 'Objectifs',
  url: '/manager/objectifs',
  icon: Target
}, {
  title: 'Prévisions',
  url: '/manager/previsions',
  icon: TrendingUp
}, {
  title: 'Alertes',
  url: '/manager/alertes',
...
export function AppSidebar() {
  ...
  return <Sidebar collapsible="icon" className="border-r border-sidebar-border">
      <SidebarHeader className="border-b border-sidebar-border p-4">
        <div className="flex items-center gap-3">
          ...
          {!collapsed && <div className="flex flex-col">
              <span className="font-display font-semibold text-sidebar-foreground">NICKO PLUS</span>
      ...
      <SidebarContent>
        {/* Boutique indicator */}
        {user?.boutiqueName && !collapsed && <div className="px-4 py-3">
        ...
        <SidebarGroup>
          ...
          <SidebarGroupContent>
            <SidebarMenu>
              <SidebarMenuItem>
                <SidebarMenuButton asChild isActive={isActive('/profil')} tooltip="Mon Profil">
                  <Link to="/profil">
      ...
      <SidebarFooter className="border-t border-sidebar-border p-4">
        {!collapsed && user && <div className="mb-3 flex items-center gap-3">
        ...
        <Button variant="ghost" className="w-full justify-start text-sidebar-muted hover:bg-sidebar-accent hover:text-sidebar-foreground" onClick={signOut}>
